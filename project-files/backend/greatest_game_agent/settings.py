"""
Django settings for Greatest Game Agent project.
"""
...
ROOT_URLCONF = 'greatest_game_agent.urls'
...
WSGI_APPLICATION = 'greatest_game_agent.wsgi.application'
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': config('DJANGO_SECRET_KEY', default=SECRET_KEY),
}
...
# CSRF and Security
CSRF_TRUSTED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='http://localhost:3000,http://localhost:8000', cast=lambda v: [s.strip() for s in v.split(',')])
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@greatestgame.com')
SERVER_EMAIL = config('SERVER_EMAIL', default='server@greatestgame.com')
